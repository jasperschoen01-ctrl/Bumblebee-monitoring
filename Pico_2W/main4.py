...
os.mount(sd, "/sd")                # Mount sd card at /sd path
...
# Replace the single FILENAME with a counter
recording_number = 0

while True:
    FILENAME = "/sd/recording_{:04d}.wav".format(recording_number)
    ...
    # --- Step 2: Record ---
    print("Recording", RECORD_SECONDS, "seconds... file:", FILENAME)
    offset = 0
